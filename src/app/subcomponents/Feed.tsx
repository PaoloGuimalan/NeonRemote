...
function Feed() {
  ...
  const icons: any = {
    Devices: <MdDevicesOther style={{ fontSize: "70px" }} />,
    MapTracker: <BiMapAlt style={{ fontSize: "70px" }} />,
    PeerStorage: <TiCloudStorageOutline style={{ fontSize: "70px" }} />,
    Streaming: <CiStreamOn style={{ fontSize: "70px" }} />,
    Chat: <IoChatboxEllipsesOutline style={{ fontSize: "70px" }} />,
  };
      ...
      <div className="bg-transparent w-full flex flex-row flex-wrap justify-center -mt-[60px] z-[10]">
        <div className="flex flex-col flex-1 w-full lg:max-w-[400px] p-[10px] rounded-[10px]">
          <div className="w-full pt-[25px] pb-[20px] flex flex-row gap-[0px] items-center">
            ...
            <img
              src={SampleIcon}
              className="w-full h-full max-w-[100px] max-h-[40px] cursor-pointer object-cover"
            />
          ...
          <div className="w-full pb-[20px] pl-[0px] pr-[20px] pt-[10px] rounded-[10px]">
            <span className="text-[14px] flex text-justify tracking-wider">
              your gateway to seamless and intuitive device control from
              anywhere in the world. At Neon Remote, we redefine the way you
              interact with your devices by providing a unified platform for
              remote control. Whether you're managing smart home gadgets, office
              equipment, or entertainment systems, Neon Remote offers a
              user-friendly and versatile solution. Experience the power of
              connectivity as you effortlessly navigate and command your devices
              with precision and ease. Join us on the forefront of innovation,
              where convenience meets cutting-edge technology, and take control
              like never before with Neon Remote.
            </span>
          </div>
        </div>
            ...
            {featuredisplay.map((mp: any, i: number) => {
              return (
                <div
                  ...
                  style={{
                    color: mp.disabled ? "#888888" : "#000000",
                  }}
                  className="select-none scale-[1] w-full border-[2px] rounded-[10px] border-[#e5e6ea] max-w-[270px] min-h-[190px] bg-transparent cursor-pointer flex flex-col items-center p-[10px] pt-[15px] pb-[20px] gap-[5px]"
                >
